...
const items = [
  ...
  },
  {
    ...
    boxShadow:
      "inset 1px 0 0 0 rgba(244, 63, 94, 0.4), inset -1px 0 0 0 rgba(244, 63, 94, 0.4)",
    maskImage: "linear-gradient(to right, black 80%, transparent 100%)",
    text: "text-rose-400",
    // badge: '6 MO',
  },
    ...
    <div className="flex flex-col items-center justify-center h-full w-full px-8">
        ...
        <div className="grid grid-cols-[160px_1fr] mb-1">
          ...
          <div className="grid grid-cols-6">
            {MONTHS.map((m) => (
              <div
                key={m}
                className="text-xs text-center text-muted-foreground/60 uppercase tracking-wider font-semibold"
              >
                {m}
              </div>
            ))}
      ...
      >
        <p className="text-sm text-foreground">
          ...
          over all development work. Every item ships faster if adoption demands
          it.
        </p>
      </motion.div>
    </div>
