...
export default function PresentationFeature() {
          ...
          {slide.market && (
            <div className="mt-4 space-y-2">
              {slide.market.map((item, i) => (
                <div key={i} className="border border-primary  p-2 sm:p-3 bg-muted/50">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="font-semibold text-xs sm:text-sm text-foreground">{item.segment}</div>
                    </div>
  ...
  return (
    ...
    >
      <button
        onClick={prevSlide}
        className="absolute top-8 right-11 sm:right-15 z-10 p-2 border border-primary  hover:bg-primary hover:text-white transition-all"
      >
      ...
      <button
        onClick={nextSlide}
        className="absolute top-8 right-2 z-10 p-2 border border-primary  hover:bg-primary hover:text-white transition-all"
      >
