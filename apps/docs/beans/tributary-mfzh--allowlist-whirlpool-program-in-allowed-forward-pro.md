...
updated_at: 2026-07-26T12:13:49Z
...
- [x] Add Whirlpool pubkey to ALLOWED_FORWARD_PROGRAMS with comment
- [x] anchor build green

## Summary of Changes

- `programs/tributary/src/constants.rs` — added `pubkey!("whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc"), // Orca Whirlpool` as the fourth entry of `ALLOWED_FORWARD_PROGRAMS`.
- `anchor build` green — program compiles and tests pass with the new allowlist entry.
