...
import { availableTokensAtom, setTokenMetadataAtom, tokenMetadataAtom } from '@/lib/token-store'
...
function LogoCell({ symbol, logoURI }: { symbol: string; logoURI: string | null }) {
  if (logoURI) {
    return (
      <img
        src={logoURI}
