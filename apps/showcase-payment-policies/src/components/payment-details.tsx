// ponytail: THIRD copy (showcase-payments + checkout + showcase-payment-policies).
// EXTRACT NOW: move to a shared @tributary-so/ui package.
// Third copy triggers extraction into a shared @tributary-so/ui package.
