...
export default class PdaUserPayment extends BaseCommand {
  ...
  static flags = {
    ...
    'token-mint': Flags.string({char: 'm', description: 'Token mint public key', required: true}),
    user: Flags.string({char: 'u', description: 'User (owner) public key', required: true}),
  }
