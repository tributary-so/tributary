...
var leb128 = require('@minhducsun2002/leb128');
...
var getCompactU64Serializer = () => ({
  description: "leb128",
  fixedSize: null,
  maxSize: null,
  serialize: (value) => leb128.LEB128.encode(value),
  deserialize: (bytes4, offset = 0) => {
    const value = leb128.LEB128.decode(bytes4, offset);
    return [value, offset + leb128.LEB128.encode(value).length];
  }
});
function getAccountInfoAssertionsSerializer() {
  return serializers.array(getAccountInfoAssertionSerializer(), {
    size: getCompactU64Serializer()
  });
}
function getMintAccountAssertionsSerializer() {
  return serializers.array(getMintAccountAssertionSerializer(), {
    size: getCompactU64Serializer()
  });
}
function getStakeAccountAssertionsSerializer() {
  return serializers.array(getStakeAccountAssertionSerializer(), {
    size: getCompactU64Serializer()
  });
}
function getTokenAccountAssertionsSerializer() {
  return serializers.array(getTokenAccountAssertionSerializer(), {
    size: getCompactU64Serializer()
  });
}
function getUpgradeableLoaderStateAssertionsSerializer() {
  return serializers.array(getUpgradeableLoaderStateAssertionSerializer(), {
    size: getCompactU64Serializer()
  });
}
function getAccountDataAssertionSerializer() {
  return umiSerializersCore.mapSerializer(
    serializers.struct(
      [
...
function getAccountDataAssertionsSerializer() {
  return serializers.array(getAccountDataAssertionSerializer(), {
    size: getCompactU64Serializer()
  });
}
function getCompactBytesSerializer() {
  return serializers.array(serializers.u8(), {
    size: getCompactU64Serializer()
  });
}
  ...
  return serializers.dataEnum(
    [
      ...
      [
        "Bytes",
        serializers.struct([
          ["fields", serializers.tuple([getCompactBytesSerializer()])]
        ])
      ],
      [
        "Pubkey",
...
var EquatableOperator6 = /* @__PURE__ */ ((EquatableOperator17) => {
  EquatableOperator17[EquatableOperator17["Equal"] = 0] = "Equal";
  EquatableOperator17[EquatableOperator17["NotEqual"] = 1] = "NotEqual";
  return EquatableOperator17;
})(EquatableOperator6 || {});
...
var LogLevel = /* @__PURE__ */ ((LogLevel2) => {
  ...
  LogLevel2[LogLevel2["FailedPlaintextMessage"] = 4] = "FailedPlaintextMessage";
  LogLevel2[LogLevel2["FailedEncodedMessage"] = 5] = "FailedEncodedMessage";
  LogLevel2[LogLevel2["FailedEncodedNoop"] = 6] = "FailedEncodedNoop";
  return LogLevel2;
})(LogLevel || {});
...
function getAssertAccountDataMultiInstructionDataSerializer() {
  return serializers.mapSerializer(
    serializers.struct(
      [
        ["discriminator", serializers.u8()],
...
function assertAccountDataMulti(context, input) {
  const programId = context.programs.getPublicKey(
    "lighthouse",
    "L2TExMFKdjpN9kozasaurPirfHy9P8sbXoAN1qA3S95"
  );
...
var LIGHTHOUSE_PROGRAM_ID = "L2TExMFKdjpN9kozasaurPirfHy9P8sbXoAN1qA3S95";
...
// src/registry/VoteAccountAssertion.ts
function assertVoteAccount(context, input) {
  let assertions = [];
...
exports.assertAccountDataMulti = assertAccountDataMulti;
...
exports.assertVoteAccount = assertVoteAccount;
...
exports.getAssertAccountDataMultiInstructionDataSerializer = getAssertAccountDataMultiInstructionDataSerializer;
