...
import { dataEnum, struct, u64, publicKey as publicKey$1, bool, bytes, i128, scalarEnum, tuple, option, u8, u16, u32, u128, i8, i16, i32, i64, unit, mapSerializer, array } from '@metaplex-foundation/umi/serializers';
import { mapSerializer as mapSerializer$1 } from '@metaplex-foundation/umi-serializers-core';
...
var getCompactU64Serializer = () => ({
  ...
  fixedSize: null,
  maxSize: null,
  serialize: (value) => LEB128.encode(value),
  deserialize: (bytes4, offset = 0) => {
    const value = LEB128.decode(bytes4, offset);
