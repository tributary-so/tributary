...
use crate::ExecutePaymentCase0;

impl<'info> ExecutePaymentCase0<'info> {
    #[qed(verified, spec = "../tributary.qedspec", handler = "execute_payment", hash = "e896c25b89ed5486", spec_hash = "4430a3a05c4729c8")]
    #[inline(always)]
    pub fn handler(&mut self, chunk: u64, current_time: u64) -> Result<()> {
        guards::execute_payment_case_0(self, chunk, current_time)?;
