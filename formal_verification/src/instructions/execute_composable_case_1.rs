...
use crate::errors::*;
use crate::ExecuteComposableCase1;

impl<'info> ExecuteComposableCase1<'info> {
    #[qed(verified, spec = "../tributary.qedspec", handler = "execute_composable", hash = "20266f4075b545f3", spec_hash = "4430a3a05c4729c8")]
    #[inline(always)]
    pub fn handler(&mut self, chunk: u64, current_time: u64, min_output: u64) -> Result<()> {
        guards::execute_composable_case_1(self, chunk, current_time, min_output)?;
